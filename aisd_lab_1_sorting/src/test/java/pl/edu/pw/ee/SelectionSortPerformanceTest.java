...
public class SelectionSortPerformanceTest {
    ...
    public void bestCaseScenarioPerformanceTest() {
        ...
        for (int i = 199; i < n; i += 200) {
            ...
            try {
                PrintWriter printWriter = new PrintWriter(new FileWriter("SelectionTestTimeOptimistic", true));
    ...
    public void worstCaseScenarioPerformanceTest() {
        ...
        for (int i = 199; i < n; i += 200) {
            ...
            try {
                PrintWriter printWriter = new PrintWriter(new FileWriter("SelectionTestTimePessimistic", true));
                printWriter.printf("%d %d%n", i + 1, ((end - start) / 10));
                printWriter.close();
            } catch (IOException e) {
            }
    ...
    public void randomDataPerformanceTest() {
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                PrintWriter printWriter = new PrintWriter(new FileWriter("SelectionTestTimeRandom", true));
